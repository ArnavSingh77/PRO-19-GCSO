...
var car, wall;
var speed,weight;
var lightIndicator, redLight, yellowLight, greenLight;
...
function setup() {
  ...
  //creating speed and weight of the car
  speed = random(55,90);
  weight = random(400,1500);

  //create the lightIndicator
  lightIndicator = createSprite(580,300,400,70);
  lightIndicator.shapeColor = "black";
...
function draw() {
  ...
  //make the background lightGreen
  background("lightgreen");
  

  //Writing code for testing the car's safety
if (wall.x-car.x<(car.width+wall.width)/2){

car.velocityX = 0;
var deformation = 0.5*weight*speed*speed/22509;

//when deformation is greater than 180, red light changes its color to red
if (deformation>180){
  redLight.shapeColor = ("red");
}
//when deformation is lesser than 180 and greater than 100, yellow light changes its color to yellow
if (deformation<180 && deformation>100){
  yellowLight.shapeColor = "yellow";
}
//when deformation is lesser than 180, green light changes its color to green
if (deformation<100){
...
//Writing the Algorithm for collosion
function collision(){
